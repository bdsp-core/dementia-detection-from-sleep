...
| `data/cohort/MGH_dementia_all_04082025_Elissa_rule_made_by_Haoqi.csv` | ✅ | `box:.../BDSP_deID/I0001-MGB/data_Outcomes/mild_cognitive_impairment/old/` — 23,828 deidentified diagnosis dates. |
...
| **`s3://.../sleep-dementia-detection/{mastersheet_outcome_deid.xlsx, MGH_dementia_all_*.csv}`** | ✅ | The SBOP crosswalk + the BDSP-deID dementia diagnosis-date table. |
