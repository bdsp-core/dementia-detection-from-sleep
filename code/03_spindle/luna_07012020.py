...
theta_lst = [2.6,4.5,5]  #th=4.5
min_t_lst = [0.4] #min=0.3
max_t_lst = [2.6]#np.linspace(2.2,4,19) #max=3
gap_lst = [0.3,0.5,0.7] #
...
for comb in combs:
    ...
    output_results_path = '/home/exx/Desktop/spindleOpt/results/07012020/' + comb_string
