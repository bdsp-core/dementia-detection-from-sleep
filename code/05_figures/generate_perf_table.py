...
eeg_folder = '${SBOP_DATA_ROOT}/code-haoqi/survival_results_NREM_bt1000'
ahi_folder = '${SBOP_DATA_ROOT}/code-haoqi/survival_results_AHI_bt1000'
hb_folder = '${SBOP_DATA_ROOT}/code-haoqi/survival_results_HB_bt1000'
red_folder = '${SBOP_DATA_ROOT}/code-haoqi/survival_results_RED_bt1000'
bai_folder = '${SBOP_DATA_ROOT}/code-haoqi/survival_results_BAI_bt1000'
se_folder = '${SBOP_DATA_ROOT}/code-haoqi/survival_results_SE_bt1000'
remperc_folder = '${SBOP_DATA_ROOT}/code-haoqi/survival_results_REMPerc_bt1000'
waso_folder = '${SBOP_DATA_ROOT}/code-haoqi/survival_results_WASO_bt1000'
